/* ============================================================
   HERO — WebGL scene (raw WebGL1, stateless, no deps)
   Left: crisp DOM type. Right: holographic globe — glowing
   nodes on a fibonacci sphere, a plexus web of nearest-neighbour
   links, and tilted orbit rings, slowly rotating and reacting
   to the pointer. Ambient silk streams + dust fill the frame.
   ============================================================ */
(function(){
'use strict';
...
if(!silk || !edges || !rings || !nodes || !dust){ fallback(); return; }
...
function tick(now){
  ...
  if(morphTarget !== morph){
    ...
    morph = morphStart + (morphTarget - morphStart) * e2;
